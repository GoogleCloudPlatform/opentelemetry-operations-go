...
func NewPullServer() (*pullServer, error) {
...
// appropriate.
func (s *pullServer) Shutdown(ctx context.Context) {
...
func (s *pullServer) respond(ctx context.Context, testID string, res *response) error {
	m := &pubsub.Message{
		Data: res.data,
