...
func (*basicTraceHandler) handle(ctx context.Context, req request, tracerProvider *sdktrace.TracerProvider) *response {
	...
	_, span := tracer.Start(ctx, "basicTrace",
		trace.WithAttributes(
			attribute.String(testIDKey, req.testID),
			attribute.String("test1", "foo"),
			attribute.String("test2", "foo"),
			attribute.String("test3", "foo"),
			attribute.String("test4", "foo"),
			attribute.String("test5", "foo"),
			attribute.String("test6", "foo"),
			attribute.String("test7", "foo"),
			attribute.String("test8", "foo"),
			attribute.String("test9", "foo"),
			attribute.String("test10", "foo"),
			attribute.String("test11", "foo"),
			attribute.String("test12", "foo"),
			attribute.String("test13", "foo"),
			attribute.String("test14", "foo"),
			attribute.String("test15", "foo"),
			attribute.String("test16", "foo"),
			attribute.String("test17", "foo"),
			attribute.String("test18", "foo"),
			attribute.String("test19", "foo"),
			attribute.String("test20", "foo"),
			attribute.String("test21", "foo"),
			attribute.String("test22", "foo"),
			attribute.String("test23", "foo"),
			attribute.String("test24", "foo"),
			attribute.String("test25", "foo"),
			attribute.String("test26", "foo"),
			attribute.String("test27", "foo"),
			attribute.String("test28", "foo"),
			attribute.String("test29", "foo"),
			attribute.String("test30", "foo"),
			attribute.String("test31", "foo"),
			attribute.String("test32", "foo"),
			attribute.String("test33", "foo"),
			attribute.String("test34", "foo"),
			attribute.String("test35", "foo"),
			attribute.String("test36", "foo"),
			attribute.String("test37", "foo"),
			attribute.String("test38", "foo"),
			attribute.String("test39", "foo"),
			attribute.String("test40", "foo"),
		))
	span.End()
