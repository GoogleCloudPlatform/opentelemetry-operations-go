...
require (
	...
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/e2e-test-server v0.39.1
...
require (
	...
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/detectors/gcp v1.15.1 // indirect
