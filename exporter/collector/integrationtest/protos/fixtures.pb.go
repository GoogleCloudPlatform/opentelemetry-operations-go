...
func file_fixtures_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_fixtures_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_fixtures_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_fixtures_proto_msgTypes[3].Exporter = func(v any, i int) any {
