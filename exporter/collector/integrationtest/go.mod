...
require (
	...
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/internal/cloudmock v0.35.1
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/internal/resourcemapping v0.35.1
